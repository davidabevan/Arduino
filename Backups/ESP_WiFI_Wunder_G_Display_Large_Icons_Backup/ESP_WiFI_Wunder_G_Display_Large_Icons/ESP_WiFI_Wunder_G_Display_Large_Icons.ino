...
if (Counter == 1) {     //Thingspeak update timer. See line 189 now a function
 ...
 // delay (3000);
  ...
  // String getWindSpeed();
  //String getWindDir();//Not recognised!!!!! Is this the updated Wunderground library i wonder......Done
  ...
  String Wind_Dir=wunderground.getWindDir();
...
// tft.setTextColor(ILI9341_GREY);
  ...
  if (weathertext == "Clear") {
    ...
    tft.drawBitmap (30, 75, 175, 120, hazy);
   }
  delay(5000);
}
// To Do 3 day forecast icons will have to adapt wunderground library i think need forcast strings to link icons
// 
// 
//news feed
//************************************************************************
