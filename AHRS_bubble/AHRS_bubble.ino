/* MPU9250 Basic Example Code
 ...
 and the Teensy 3.1.
 */
// Adapted to create a virtual Bubble Meter Thanks to Kris Winer for MPU9250 Code
// Dave Bevan March 29 2020
// work in PROGRESS
#include <M5Stack.h>
    ...
    //  M5.Lcd.printf("% 6d  % 6d  % 6d      o/s  \r\n", (int)(IMU.gx), (int)(IMU.gy), (int)(IMU.gz));
     ...
     // M5.Lcd.printf("% 6d  % 6d  % 6d     mG    \r\n",  (int)(IMU.mx), (int)(IMU.my), (int)(IMU.mz));
      ...
      //M5.Lcd.printf("  yaw: % 5.2f    pitch: % 5.2f    roll: % 5.2f   \r\n",(IMU.yaw), (IMU.pitch), (IMU.roll));
       M5.Lcd.printf("    pitch: % 5.2f                  roll: % 5.2f   \r\n",(IMU.yaw), (IMU.pitch), (IMU.roll));
  M5.Lcd.drawRect(0,0,318,238,GREEN);
 // M5.Lcd.drawLine( 42,  0,  42, 48, GREEN);
   M5.Lcd.drawLine( 160,  0,  160, 238, GREEN); // mid vert 320
 // M5.Lcd.drawLine( 0,  24,  84, 24, GREEN);
   M5.Lcd.drawLine( 0,  120,  318, 120, GREEN);// mid hor 240,,,,x0,yo to x1 y1
   M5.Lcd.drawCircle(160,120,10,GREEN);// bubble
   //display.drawCircle(42,24,20,BLACK);
   //display.drawCircle(42,24,30,BLACK);
   //display.drawCircle(42,24,40,BLACK);
  // M5.Lcd.fillCircle(IMU.gy,(IMU.gx),4,GREEN);
   // M5.Lcd.fillCircle(-IMU.pitch +160,(-IMU.roll +120),4,GREEN);// cursor
     M5.Lcd.fillCircle(-IMU.pitch +160,(-IMU.roll +120),4,GREEN);// cursor
    ...
    // well!
      ...
      //M5.Lcd.fillScreen(BLACK);
      delay (100);
        M5.Lcd.fillCircle(-IMU.pitch +160,(-IMU.roll +120),4,BLACK);// cursor
      //M5.Lcd.clear(BLACK);
#endif // LCD
