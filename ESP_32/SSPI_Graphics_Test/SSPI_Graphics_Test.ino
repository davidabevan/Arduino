 ...
 ****************************************************/
// sidenote
//minimum 16bit to set the colour of one pixel
//paralle11 16 does this in 1 cycle
//parallell 8 in 2 cycles
// the spi takes 16 cycles
#include "SPI.h"
...
void loop(void) {
  for(uint8_t rotation=0; rotation<4; rotation++) {
   ...
   tft.begin();tft.setRotation(3);tft.fillScreen(ILI9341_BLACK); tft.setTextSize(3);tft.println("Finished...");delay(100000);
}
