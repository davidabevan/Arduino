...
//#include <M5Stack.h> 
//Display pins (current is default for HB0020 Badge)//m5stack
#define TFT_CS   14  //19
#define TFT_DC   27 //22
#define TFT_MOSI 23 //23
#define TFT_CLK  18 //26
#define TFT_RST  33 //21
#define TFT_MISO 19 //25
#define led_pin 32
...
void setup() {
  ...
  pinMode(led_pin, OUTPUT); // Lcd led pin
   ...
   digitalWrite(32, HIGH);// Turn on lcd led backight
  tft.begin();
  tft.setRotation(3);
