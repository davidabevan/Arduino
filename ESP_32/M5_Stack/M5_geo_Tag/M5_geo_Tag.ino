...
void drawMap() {
  ...
  //http.begin("http://maps.googleapis.com/maps/api/staticmap?center=" + COORDS + "&zoom=" + String(zoom) + "&size=320x260&format=jpg-baseline&markers=color:blue%7Csize:mid%7Clabel:H%7C" + COORDS + ""&key=
  //AIzaSyD8IH-E3o2KyLAHo_kKxH0tAD9GyBAcmeM);
 // https://maps.googleapis.com/maps/api/staticmap?center=40.714%2c%20-73.998&zoom=12&size=400x400&key=AIzaSyD8IH-E3o2KyLAHo_kKxH0tAD9GyBAcmeM
...
void setup() {
  ...
  String wifi_ssid = "PLUSNET-9P9QR6";
  String wifi_password = "3bb7bc7cd3";
