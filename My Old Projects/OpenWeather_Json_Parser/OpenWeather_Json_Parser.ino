...
const char PASSWORD[] = "3bb7bc7cd3";    // your network password (use for WPA, or use as key for WEP)
//int keyIndex = 0e8e64147c64fdb80045c4eed75b4b37;            // your network key Index number (needed only for WEP)

String nameOfCity = "London,UK  ";   // your city of interest here in format "city,countrycode"
...
#define APIKEY "0e8e64147c64fdb80045c4eed75b4b37"
WiFiClient client;
...
void httpRequest() {
  ...
  if (client.connect(server, 80)) {
    ...
    Serial.println("Get OpenweatherMap ForeCast...");
   // client.println("GET /data/2.5/weather?q=" + nameOfCity + APIKEY+ "&mode=json&units=metric&cnt=2 HTTP/1.1\r\n");
   // client.println("GET /data/2.5/find?q=Bugle&units=metric&APPID=0e8e64147c64fdb80045c4eed75b4b37.json HTTP/1.1\r\n");
  client.println("GET /data/2.5/forecast?q=Bugle&units=metric&APPID=0e8e64147c64fdb80045c4eed75b4b37 HTTP/1.1\r\n");
 // client.println("GET /data/2.5/weather?q=London,uk&lang=en&units=metric&appid=0e8e64147c64fdb80045c4eed75b4b37");
