/*
 * Modified for Esp_8266 and ILI9341 spi display Aug 7 2016 DB----
 * The clock shows time as of compilation 
 * Problems display showing red artifacts from second hand----
...
//***************************************************
// These are the connections for the Esp_8266
#define sclk 7  // Don't change
#define mosi 6  // Don't change
#define cs   3
#define dc   5
...
Adafruit_ILI9341 tft = Adafruit_ILI9341(TFT_CS, TFT_DC);// Invoke custom library
...
uint16_t hh=conv2d(__TIME__), mm=conv2d(__TIME__+3), ss=conv2d(__TIME__+6);  // Get H, M, S from compile time
boolean initial = 1;
