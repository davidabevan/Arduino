...
void setup(void) {
  ...
  tft.println(40, 150, "Tic Tac Touch", WHITE, 2);
  tft.println(66, 190, "thecustomgeek.com", WHITE);
  delay(1500);
  drawboard();
...
void loop()
{
  ...
  void catseye() {
    ...
    tft.println(10, 275, "Mosfet Eye!", WHITE, 2);
    mosfets++;
    updatewins();
    gameover = 1;
  }
  ...
  void playeronewin() {
    tft.fillRect(10, 260, 96, 8, BLACK);
    tft.println(10, 275, "Player 1 wins!", WHITE, 2);
    ponewins++;
    updatewins();
    gameover = 1;
  }
  void playertwowin() {
    tft.fillRect(10, 260, 96, 8, BLACK);
    tft.println(10, 275, "Player 2 wins!", WHITE, 2);
    ptwowins++;
    updatewins();
    gameover = 1;
  }
  ...
  void showturn() {
    if (turn == 1) {
      tft.fillRect(10, 260, 96, 8, BLACK);
      tft.println(10, 260, "Player 1's turn!", GREEN);
    }
    if (turn == 2) {
      tft.fillRect(10, 260, 96, 9, BLACK);
      tft.println(10, 260, "Player 2's turn!", RED);
    }
  }
  void drawboard() {
    tft.fillScreen(BLACK);
  ...
  tft.println(196, 290, "Reset", YELLOW);
  showturn();
  tft.println(10, 290, "Player 1 wins:", YELLOW);
  tft.println(10, 300, "Player 2 wins:", YELLOW);
  tft.println(10, 310, "Mosfet eyes:", YELLOW);
  updatewins();
  }
