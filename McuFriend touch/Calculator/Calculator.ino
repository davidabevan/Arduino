...
// Spent 2 days trying to get this working. in the end switching
//X and Y coords fixed it i couldnt work his mapping out for the lcd
void DetectButtons()
{
  
  if (Y<50 && Y>16) //Detecting Buttons on Column 1
  {
    if (X>23 && X<62)//85 //If cancel Button is pressed
    {Serial.println ("Button Cancel"); Number=Num1=Num2=0; result=false;}
    
     if (X>85 && X<130) //If Button 1 is pressed
    ...
    Number = (Number*10) + 1; //Pressed twice
     ...
     if (X>140 && X<192) //If Button 4 is pressed
    ...
    Number = (Number*10) + 4; //Pressed twice
     ...
     if (X>192 && X<245) //If Button 7 is pressed
    ...
    if (Y<105 && Y>50) //Detecting Buttons on Column 2
  {
    if (X>0 && X<85)
    ...
    if (Y<165 && Y>105) //Detecting Buttons on Column 3
  {
    if (X>0 && X<85)
    ...
    Number = (Number*10) + 9; //Pressed twice
      ...
      if (Y<213 && Y>165) //Detecting Buttons on Column 4
  {
    Num1 = Number;    
    Number =0;
