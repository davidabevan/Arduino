...
//tft.setCursor(50,70);
//tft.print("Date");
//String date = wunderground.getDate();//**********USE
 //tft.print( date);// Displays datex, y; coords of text output. x=left&right y=up&down
...
//tft.print (wunderground.getHumidity());
 // display->drawString(96 + x, 10 + y, wunderground.getPressure());
  ...
  // delay (30000);
  // GetWeatherUpdate();
 // WundergroundClient.updateConditions(WUNDERGRROUND_API_KEY, WUNDERGROUND_COUNTRY, WUNDERGROUND_CITY);
   wunderground.getPressure();
 }
 //*********************************************
// updatetime();
