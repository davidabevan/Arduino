...
tft.setTextWrap(false); // Don't wrap text to next line
 ...
 // delay (2000);// mod on sundayDB set to ignore
  tft.fillScreen(ILI9341_GREY);
//  DrawClockFace();
...
void loop()
{
  ...
  //  Serial.print("T");
   ...
   // delay(1000);// set to ignore DB sunday
  ...
  }//-----LEAVE!!!!!!!!DB CAUSES Compile error if ignored
